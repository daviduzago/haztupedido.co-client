    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View>
          ...
          <Text style={{ fontSize: 22, fontWeight: "bold", marginVertical: 2 }}>
            {direccion}
          </Text>
          <Text style={{ fontSize: 20, fontWeight: "bold", marginVertical: 2 }}>
            {direccionDescrip}
          </Text>
          <TouchableWithoutFeedback
      ...
      >
        ...
        />
        <ButtonCheckOut width={140} image={require("../assets/epayco.png")} />
      </View>
